...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 8
 testRunner.Given("I logged into turnup up portal successfully", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 9
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Time", "Galen", "$20.00", null)]
        [NUnit.Framework.TestCaseAttribute("Material", "Keyboard", "$100.00", null)]
        [NUnit.Framework.TestCaseAttribute("EditedRecord", "Mouse", "$1,500.00", null)]
...
#line hidden
#line 17
 testRunner.Then(string.Format("The record should been updated \'{0}\', \'{1}\' and \'{2}\'", description, code, price), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
